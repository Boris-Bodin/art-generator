"""Tests des résolutions, du rendu par tuiles et de l'export vectoriel."""
...
# --- Indépendance à la résolution (densité constante) -------------------------
...
# --- Fonds par bandes (base du rendu par tuiles) ------------------------------
